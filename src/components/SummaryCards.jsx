    ...
    <div className="grid sm:grid-cols-3 justify-center items-center gap-4">
      <div className="bg-white rounded shadow flex justify-start items-center p-5">
        ...
        <div className=" grid justify-center items-center h-[49px] ml-1">
          <h4 className="font-semibold text-gray-700 text-[16px] -mt-1">
            Income
          </h4>
          <p className="text-xl font-bold text-gray-400">₹{totalIncome}</p>
        </div>
      </div>
      <div className="bg-white rounded shadow flex justify-start items-center p-5">
        ...
        <div className=" grid justify-center items-center h-[49px] ml-1">
          ...
          <p className="text-xl font-bold text-gray-400">₹{safeBalance}</p>
        </div>
      </div>
      <div className="bg-white rounded shadow flex justify-start items-center p-5">
        ...
        <div className=" grid justify-center items-center h-[49px] ml-1">
          ...
          <p className="text-xl font-bold text-gray-400">₹{totalExpenses}</p>
        </div>
      </div>
    </div>
  );
